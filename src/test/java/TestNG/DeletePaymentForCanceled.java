...
public class DeletePaymentForCanceled {
	...
	public void login() throws InterruptedException{
		...
		WebElement message=driver.findElement(By.xpath("//div[@class='detail slds-text-align--center']"));
		String m=wait.until(ExpectedConditions.elementToBeClickable(message)).getText();
		
		if(m.equalsIgnoreCase("Delete not allowed when Status is Canceled")){
			
			WebElement closeButton=driver.findElement(By.xpath("//button[contains(@class,'modal__close')]"));
