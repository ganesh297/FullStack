...
public class TC011_Assessment1 extends BaseTest {
	...
	public void DashboardVerification() throws InterruptedException{
		...
		WebElement daily=driver.findElement(By.xpath("//legend[text()='Frequency']//following::span[text()='Daily']//parent::label"));
