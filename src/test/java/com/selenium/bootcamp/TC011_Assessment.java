...
public class TC011_Assessment {
	...
	public static void main(String[] args) throws InterruptedException, IOException, AWTException {
		...
		String DashboardName="Testing123";
		...
		try{
			...
			System.out.println("Window Size: "+windowSize.size());
			}catch(Exception e){
		...
		if(getToastMessageText.contains("You started a dashboard subscription.")){
